                    ...
                    <div class="modal-body">
                        ...
                        <?php else: ?>
                            <div class="alert alert-warning">
                                An error occurred during SignUp :<br>
                                <?php echo $msg ?>
                            </div>
                            <br>
                ...
                <div class="modal-body">
                    ...
                    <form class="form-signin" action="" method="post">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control input-xlarge" id="password" name="password"
                                       type="password"
                                       required="required"
                    ...
                    <textarea class="form-control input-xlarge" id="members" name="members" type="text" rows="3"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control input-xlarge" id="description" name="description"
                                       type="text"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control input-xlarge" id="captcha" name="captcha" type="text"
                                       placeholder=""
