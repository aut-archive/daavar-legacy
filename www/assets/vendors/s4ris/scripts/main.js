...
function createTemplateRow(idx) {
    $('#standings-table').append('<div class="element" id="' + idx + '" style=" z-index:0"><table class="contestant-info"><tr><td><div class="contestant"></div></td></tr><tr style="top 50px;"><td><table class="problems-list"><tr><td class="info"><div class="info-caption">' +
        "Place" +
        '</div><div class="info-text" id="place">0</div></td><td class="problem"><div class="problem-caption">&nbsp;</div><div class="problem-result" id="no-submitions">.</div></td><td class="info"><div class="info-caption">' +
        "SolvedProblems" +
        '</div><div class="info-text" id="totalSolved">0</div></td><td class="info"><div class="info-caption">' +
        "Penalty" +
        '</div><div class="info-text" id="penalty"></div></td></tr></table></td></tr></table></div>');
