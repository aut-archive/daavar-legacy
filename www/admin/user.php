...
if (!empty($cmd)):
    ...
    ?>
    <tr>
        <td><label for="data_0__name_">Full name:</label></td>
        <td><?php echo addInput('data[0][name]', @$row['name'], 35, 255, 'autocomplete="off"') ?></td>
    </tr>
    <tr>
        <td><label for="data_0__email_">Email:</label></td>
        <td><?php echo addInputField('email', 'data[0][email]', @$row['email'], ' size="35" maxlength="255" autocomplete="off"') ?></td>
    </tr>

    <tr>
        <td><label for="data_0__password_">Password:</label></td>
        <td><?php
            ...
            change: <?php echo addInputField('text', 'data[0][password]', "", 'size="19" maxlength="255" autocomplete="off"') ?></td>
    </tr>
    <tr>
        <td><label for="data_0__ip_address_">IP Address:</label></td>
        <td><?php echo addInput('data[0][ip_address]', @$row['ip_address'], 35, 255,'autocomplete="off"') ?></td>
    </tr>

    <tr>
        <td><label for="data_0__enabled_">Enabled:</label></td>
    ...
    <!-- team selection -->
    <tr>
        <td><label for="data_0__teamid_">Team:</label></td>
        <td><?php
...
?>
    ...
    <div class="col1">
        <table class="table">
            ...
            <tr>
                <td>Login:</td>
                <td class="teamid"><?php echo htmlspecialchars($row['username']) ?></td>
            </tr>
            <tr>
                <td>Name:</td>
            ...
            <tr>
                <td>Last login:</td>
                <td><?php echo printtime($row['last_login'], '%a %d %b %Y %T %Z') ?></td>
            </tr>
            <tr>
                <td>Last IP:</td>
                <td><?php echo
                    (@$row['ip_address'] ? printhost($row['ip_address'], TRUE) : '') ?></td>
            </tr>
        </table>
    </div>
