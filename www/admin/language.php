...
if (!empty($cmd)):
    ...
    ?>
    <tr>
        <td><label for="data_0__name_">Language name:</label></td>
        <td><?php echo addInput('data[0][name]', @$row['name'], 20, 255, 'required') ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo addRadioButton('data[0][allow_submit]', (!isset($row['allow_submit']) || $row['allow_submit']), 1) ?>
            ...
            <label for="data_0__allow_submit_0">no</label></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo addRadioButton('data[0][allow_judge]', (!isset($row['allow_judge']) || $row['allow_judge']), 1) ?>
            ...
            <label for="data_0__allow_judge_0">no</label></td>
    </tr>

    <tr>
        <td><label for="data_0__time_factor_">Time factor:</label></td>
        <td><?php echo addInputField('number', 'data[0][time_factor]', @$row['time_factor'], ' min="0" step="any"') ?>
            x
        </td>
    </tr>
    <tr>
        <td><label for="data_0__compile_script_">Compile script:</label></td>
        <td>
            <?php
    ...
    <tr>
        <td><label for="data_0__extensions_">Extensions:</label></td>
        <td><?php echo addInput('data[0][extensions]', @$row['extensions'], 20, 255, 'required') ?> (as JSON encoded
            array)
        </td>
    </tr>
    </table>
...
?>
    <table>
        <tr>
            <td>ID/extension:</td>
            <td><?php echo htmlspecialchars($data['langid']) ?></td>
        </tr>
        <tr>
            <td>Name:</td>
        ...
        <tr>
            <td>Allow submit:</td>
            <td><?php echo printyn($data['allow_submit']) . ' ' .
        ...
        <tr>
            <td>Allow judge:</td>
            <td><?php echo printyn($data['allow_judge']) . ' ' .
        ...
        <tr>
            <td>Time factor:</td>
            <td><?php echo htmlspecialchars($data['time_factor']) ?> x</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Extensions:</td>
            <td><?php echo htmlspecialchars($data['extensions']) ?></td>
        </tr>
    </table>
