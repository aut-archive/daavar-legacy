...
// FIXME: unzip and show zip here
    ?>
    <tr>
        <td><label for="data_0__description_">Executable description:</label></td>
        <td><?php echo addInput('data[0][description]', @$row['description'], 30, 255, 'required') ?></td>
    </tr>
    <tr>
        <td><label for="data_0__type_">Executable type:</label></td>
        <td><?php echo addSelect('data[0][type]', array('compare' => 'compare',
                'compile' => 'compile',
                'run' => 'run'), @$row['type'], True)?></td>
    </tr>
...
<table>
    <tr>
        <td>ID:</td>
        <td class="execid"><?php echo htmlspecialchars($data['execid']) ?></td>
    </tr>
    <tr>
        <td>Name:</td>
    ...
    <tr>
        <td>md5sum:</td>
        <td><?php echo htmlspecialchars($data['md5sum']) ?></td>
    </tr>
    <tr>
        <td>type:</td>
    ...
    <tr>
        <td>size:</td>
        <td><?php echo htmlspecialchars($data['size']) ?> Bytes</td>
    </tr>
    <tr>
        <td>content:</td>
        <td><a href="show_executable.php?id=<?php echo htmlspecialchars($id) ?>">view content of zip file</a></td>
    </tr>
    <tr>
        <td>used as <?= $data['type'] ?> script:</td>
        <td>
            <?php
