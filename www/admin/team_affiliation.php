...
if (!empty($_GET['cmd'])):
    ...
    <tr>
        ...
        <td><?php echo addInput('data[0][shortname]', @$row['shortname'], 40, 30, 'required') ?></td>
    </tr>

    <tr>
        <td><label for="data_0__name_">Name:</label></td>
        <td><?php echo addInput('data[0][name]', @$row['name'], 40, 255, 'required') ?></td>
    </tr>

    <tr>
        <td><label for="data_0__country_">Country:</label></td>
...
$affillogo = "../assets/images/affiliations/" . urlencode($data['affilid']) . ".png";
$countryflag = "../assets/images/countries/" . urlencode($data['country']) . ".png";
