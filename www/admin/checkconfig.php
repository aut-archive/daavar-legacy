...
function flushresults()
{
    ...
    foreach ($RESULTS as &$row) {
        ...
        echo "<tr class=\"result " . htmlspecialchars($row['result']) .
            "\"><td class=\"resulticon\"><img src=\"../assets/images/s_";
        switch ($row['result']) {
            case 'O':
                echo "okay";
                break;
            ...
            case 'R':
                ...
                break;
            default:
                error("Unknown config checker result: " . $row['result']);
        }
        echo ".png\" alt=\"" . $row['result'] . "\" class=\"picto\" /></td><td>" .
            htmlspecialchars($row['item']) . " " .
            "<a href=\"javascript:collapse($resultno)\"><img src=\"../assets/images/b_help.png\" " .
...
echo "<table class=\"table configcheck\">\n";
...
echo "<p>Legend:
<img src=\"../assets/images/s_okay.png\"      alt=\"O\" class=\"picto\" /> OK
<img src=\"../assets/images/s_warn.png\"      alt=\"W\" class=\"picto\" /> Warning
<img src=\"../assets/images/s_error.png\"     alt=\"E\" class=\"picto\" /> Error
</p>\n";
